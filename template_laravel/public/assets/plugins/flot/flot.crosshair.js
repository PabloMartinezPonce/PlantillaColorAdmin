...
The plugin also adds four public methods:
  ...
  var graph = document.getElementById('graph');
	var plot = new Plot(graph , ..., { crosshair: { mode: "x" } } };

	plot.bind( "plothover", function ( evt, position, item ) {
		if ( item ) {
...
(function (root, factory) {
  ...
  function init(plot) {
    ...
    plot.hooks.bindEvents.push(function (plot, overlayElement) {
      ...
      DOMTools.addEventListener(overlayElement, 'mouseout', onMouseOut);
    ...
    plot.hooks.shutdown.push(function (plot, overlayElement) {
      DOMTools.removeEventListener(overlayElement, "mouseout", onMouseOut);
