...
<?php $__env->startPush('css'); ?>
	...
	<link href="/assets/plugins/datatables/css/colReorder/colReorder.bootstrap4.min.css" rel="stylesheet" />
		...
		<div class="col-lg-10">
			...
			<div class="panel panel-inverse">
				...
				<div class="panel-body">
					<table id="data-table-colreorder" class="table table-striped table-bordered">
						<thead>
							<tr>
								<th width="1%"></th>
