<?php $__env->startSection('title', 'Unlimited Nav Tabs'); ?>
				...
				<div class="panel-heading p-0">
					...
					<div class="tab-overflow">
						<ul class="nav nav-tabs nav-tabs-inverse">
							...
							<li class="nav-item"><a href="#nav-tab-9" data-toggle="tab" class="nav-link">Nav Tab 8</a></li>
				...
				<div class="panel-heading p-0">
					...
					<div class="tab-overflow">
						<ul class="nav nav-tabs">
							...
							<li class="nav-item"><a href="#nav-tab2-9" data-toggle="tab" class="nav-link">Nav Tab 8</a></li>
